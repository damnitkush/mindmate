        ...
        <div className="flex gap-8 items-center justify-between">
          ...
          <div className="flex gap-2 items-center justify-between">
            {user ? (
              <Link
                to="/dashboard/home"
                className="py-2 border-t border-t-primary-100 text-center rounded-lg w-fit px-8 font-medium shadow   bg-primary-50   cursor-pointer hover:text-primary-50 text-primary-800 hover:bg-primary-500 active:bg-primary-600 transition-all"
              >
                Go to Dashboard
              </Link>
            ) : (
