...
const PricingComp = () => {
  return (
    <div>
      ...
      <div className="flex gap-16 px-32 mt-20">
        ...
        <div className="border w-1/3 p-8 rounded-lg flex flex-col gap-4">
          ...
          <h2 className="text-primary-800 font-semibold text-2xl">Basic</h2>
          <span className="text-sm text-slate-700 font-light">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis,
            dignissimos.
          </span>
          <div className="flex gap-2 items-end">
            <span className="font-semibold text-5xl text-primary-700">$19</span>
            <span className="font-light text-slate-600 text-sm pb-1">
              / per month
            </span>
          </div>
